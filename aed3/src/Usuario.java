...
public class Usuario implements Registro {
    ...
    public Usuario(String nome, String senha, String cpf, String nasc, String email) {
        this.codigo = -1;
        this.nome = nome;
        this.senha = senha;
        this.cpf = cpf;
    ...
    public String toString() {
        return "Usuario{" + "codigo=" + codigo + ", nome=" + nome + ", senha=" + senha + ", cpf=" + cpf + ", nasc=" + nasc + ", email=" + email + '}';
    }
